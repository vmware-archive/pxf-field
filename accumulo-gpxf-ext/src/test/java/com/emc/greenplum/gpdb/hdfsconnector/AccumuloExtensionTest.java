...
public class AccumuloExtensionTest extends GpxfUnit {
	...
	public static void setupClass() throws Exception {
		...
		columnDefs.add(new Pair<String, Integer>("cf:a", GPDBWritable.INTEGER));
		columnDefs.add(new Pair<String, Integer>("cf:b", GPDBWritable.INTEGER));
		columnDefs.add(new Pair<String, Integer>("cf:c", GPDBWritable.INTEGER));
