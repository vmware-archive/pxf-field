...
import com.emc.greenplum.gpdb.hdfsconnector.GpxfUnit.Pair;

public class AccumuloAccessor implements IHdfsFileAccessor {
	...
	private HDFSMetaData metaData = null;
	private Pair<Key, Value> previousResult = null;
	private boolean hasNext = true;

	public AccumuloAccessor(HDFSMetaData meta) throws Exception {
		this.metaData = meta;
